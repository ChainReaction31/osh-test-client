...
OSH.SWEJsonParser=BaseClass.extend({initialize:function(json){this.originalJson=json;var x2jsOptions={xmlns:!0,attributePrefix:"",prefix:!0,removeAttrPrefix:!1};this.x2jsParser=new X2JS(x2jsOptions)},toJson:function(){return this.originalXml},toXml:function(){return this.x2jsParser.json2xml_str(this.originalJson)}});
...
OSH.UI.Styler.PointMarker=OSH.UI.Styler.extend({initialize:function(properties){if(this._super(properties),this.properties=properties,this.location=null,this.orientation={heading:0},this.icon=null,this.iconAnchor=[16,16],this.label=null,this.color="#000000",this.defaultToTerrainElevation=!1,this.description=null,this.options={},void 0!==properties.defaultToTerrainElevation&&(this.defaultToTerrainElevation=properties.defaultToTerrainElevation),void 0!==properties.location&&(this.location=properties.location),void 0!==properties.orientation&&(this.orientation=properties.orientation),void 0!==properties.icon&&(this.icon=properties.icon),void 0!==properties.iconAnchor&&(this.iconAnchor=properties.iconAnchor),void 0!==properties.label&&(this.label=properties.label),void 0!==properties.color&&(this.color=properties.color),void 0!==properties.locationFunc){var fn=function(rec,timeStamp,options){this.location=properties.locationFunc.handler(rec,timeStamp,options)}.bind(this);this.addFn(properties.locationFunc.dataSourceIds,fn)}if(void 0!==properties.orientationFunc){var fn=function(rec,timeStamp,options){this.orientation=properties.orientationFunc.handler(rec,timeStamp,options)}.bind(this);this.addFn(properties.orientationFunc.dataSourceIds,fn)}if(void 0!==properties.iconFunc){var fn=function(rec,timeStamp,options){this.icon=properties.iconFunc.handler(rec,timeStamp,options)}.bind(this);this.addFn(properties.iconFunc.dataSourceIds,fn)}if(void 0!==properties.labelFunc){var fn=function(rec,timeStamp,options){this.label=properties.labelFunc.handler(rec,timeStamp,options)}.bind(this);this.addFn(properties.labelFunc.dataSourceIds,fn)}if(void 0!==properties.colorFunc){var fn=function(rec,timeStamp,options){this.color=properties.colorFunc.handler(rec,timeStamp,options)}.bind(this);this.addFn(properties.colorFunc.dataSourceIds,fn)}void 0!==properties.description&&(this.description=properties.description)},init:function(view){this._super(view),void 0!==view&&null!=this.location&&view.updateMarker(this,0,{})},setData:function(dataSourceId,rec,view,options){this._super(dataSourceId,rec,view,options)&&void 0!==view&&null!=this.location&&view.updateMarker(this,rec.timeStamp,options)},clear:function($super){}});
